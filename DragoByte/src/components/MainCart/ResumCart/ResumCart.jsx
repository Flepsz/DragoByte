...
function ResumCart() {
  ...
  // Função para calcular o total dos produtos no carrinho incluindo o valor do frete
  ...
  // Função para finalizar a compra, removendo os itens do carrinho e reiniciando a lista de itens
      ...
      {cartItems.length > 0 ? (
        <>
          ...
          <div className="price-card__ResumCard">
            ...
            <p className="pText-pc__ResumCard">
              (Economize:{" "}
              <b>{formatCurrency(calculateTotalWithFreight() * 0.05, "BRL")}</b>{" "}
              )
            </p>
          </div>
